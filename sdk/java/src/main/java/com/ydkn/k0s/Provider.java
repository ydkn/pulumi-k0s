...
import com.ydkn.k0s.ProviderArgs;
import com.ydkn.k0s.Utilities;
import javax.annotation.Nullable;

@ResourceType(type="pulumi:providers:k0s")
public class Provider extends com.pulumi.resources.ProviderResource {
    ...
    public Provider(java.lang.String name, @Nullable ProviderArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("k0s", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
