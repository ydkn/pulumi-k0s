...
class ProviderArgs:
    def __init__(__self__, *,
                 ...
                 concurrent_uploads: pulumi.Input[Optional[_builtins.int]] = None,
                 no_drain: pulumi.Input[Optional[_builtins.bool]] = None,
                 no_wait: pulumi.Input[Optional[_builtins.bool]] = None,
                 skip_downgrade_check: pulumi.Input[Optional[_builtins.bool]] = None):
        """
        The set of arguments for constructing a Provider resource.

        :param pulumi.Input[_builtins.int] concurrency: Maximum number of hosts to configure in parallel, set to 0 for unlimited
        :param pulumi.Input[_builtins.int] concurrent_uploads: Maximum number of files to upload in parallel, set to 0 for unlimited
        :param pulumi.Input[_builtins.bool] no_drain: Do not drain worker nodes when upgrading
        :param pulumi.Input[_builtins.bool] no_wait: Do not wait for worker nodes to join
        :param pulumi.Input[_builtins.bool] skip_downgrade_check: Skip downgrade check
        """
    ...
    def concurrent_uploads(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
    ...
    def concurrent_uploads(self, value: pulumi.Input[Optional[_builtins.int]]):
        pulumi.set(self, "concurrent_uploads", value)

    @_builtins.property
    @pulumi.getter(name="noDrain")
    def no_drain(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
    ...
    @no_drain.setter
    def no_drain(self, value: pulumi.Input[Optional[_builtins.bool]]):
    ...
    def skip_downgrade_check(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
    ...
    def skip_downgrade_check(self, value: pulumi.Input[Optional[_builtins.bool]]):
        pulumi.set(self, "skip_downgrade_check", value)


@pulumi.type_token("pulumi:providers:k0s")
